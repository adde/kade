...
Below follows an example to download and install the latest version on a Mac(Apple Silicon). For other platforms, replace the binary name in the curl command with the relevant binary for your system:
